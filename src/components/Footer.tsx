                    ...
                    <div className="md:col-span-4 lg:col-span-4">
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10 backdrop-blur-sm">
                            ...
                            <a href={waLink} target="_blank" rel="noopener noreferrer"
                                className="group flex items-center justify-center gap-2.5 w-full px-6 py-3.5 rounded-xl bg-[#81A649] text-white text-sm font-bold hover:bg-[#607D2C] hover:shadow-[0_8px_25px_rgba(129,166,73,0.3)] hover:-translate-y-0.5 transition-all duration-300">
