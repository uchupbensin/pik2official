            ...
            <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isTransparent ? 'bg-transparent border-transparent text-white pt-2' : 'bg-white border-b border-gray-200/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)] text-gray-800'}`}>
                <div className="max-w-[100rem] mx-auto px-4 sm:px-8 lg:px-12">
                    <div className="flex items-center justify-between h-20 sm:h-24">
                        ...
                        {/* Center: Desktop nav */}
                        <div className="hidden lg:flex flex-1 items-center justify-center gap-x-1 lg:gap-x-2 xl:gap-x-4 px-2">
                            {menus.map((menu) => {
                        ...
                        <div className="flex-none flex justify-end items-center gap-4 z-50">
                            ...
                            <div className="hidden lg:flex items-center gap-4 xl:gap-5">
                                <div className="flex flex-col items-end text-right justify-center">
                                    ...
                                    <a href={waLink} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-1.5 mt-0.5 group/wa`}>
                                        ...
                                        <span className={`text-sm font-extrabold leading-none ${isTransparent ? 'text-white' : 'text-[#1E356A]'} group-hover/wa:underline`}>082210100303 (WISNU)</span>
                                    </a>
                                </div>
                                <a href={waLink} target="_blank" rel="noopener noreferrer"
                                    className={`group inline-flex items-center gap-1.5 px-4 lg:px-5 py-2 rounded-full text-[13px] xl:text-[14px] font-bold transition-all duration-300 ${isTransparent ? 'bg-white text-[#1E356A] hover:shadow-lg hover:-translate-y-0.5' : 'bg-[#81A649] text-white hover:bg-[#6c8d3d] shadow-md shadow-[#81A649]/20 hover:shadow-lg hover:shadow-[#81A649]/40 hover:-translate-y-0.5'}`}>
                                    <svg className="w-3.5 h-3.5 group-hover:animate-pulse" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51l-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.71.306 1.263.489 1.694.625.712.227 1.36.195 1.872.118.571-.085 1.758-.719 2.006-1.413.247-.694.247-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" /></svg>
                                    Konsultasi
                                </a>
                            </div>
                            ...
                            <div className="lg:hidden flex items-center gap-2 sm:gap-4">
                                <div className="flex flex-col items-end text-right justify-center">
                                    ...
                                    <a href={waLink} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-1 mt-0.5 group/wa`}>
                                        ...
                                        <span className={`text-[11px] sm:text-xs font-extrabold leading-none ${isTransparent ? 'text-white' : 'text-[#1E356A]'} group-hover/wa:underline`}>082210100303 (WISNU)</span>
                                    </a>
                                </div>
