...
export default function Navbar({
  ...
  return (
    <>
      {/* TOP BAR */}
      <div className="bg-[#1E356A] text-white text-xs sm:text-sm shadow-inner relative z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-9">
              <span className="font-medium tracking-wide opacity-90">{siteName}</span>
              <a href={waLink} target="_blank" rel="noopener noreferrer"
                 className="inline-flex items-center gap-2 text-white/90 hover:text-white transition-all font-semibold hover:scale-105 origin-right">
      ...
      {/* BOTTOM NAVBAR */}
      <nav className="bg-white/85 backdrop-blur-lg border-b border-gray-200/50 sticky top-0 z-40 shadow-[0_4px_30px_rgba(0,0,0,0.03)] transition-all duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16 sm:h-20">
                  ...
                  <Link href="/" className="flex items-center gap-3 group">
                      ...
                      <span className="hidden sm:block font-extrabold tracking-tight text-[#1E356A] text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#1E356A] to-[#81A649] whitespace-nowrap">
                          {siteName}
                      </span>
                  </Link>
                                ...
                                {hasChildren && (
                                    <div className="absolute left-1/2 -translate-x-1/2 top-full pt-3 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                                        <div className="bg-white/95 backdrop-blur-xl border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.08)] rounded-2xl overflow-hidden py-2 relative">
                                            ...
                                            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#1E356A] to-[#81A649]"></div>
                  ...
                  <div className="flex items-center gap-3">
                      ...
                      <div className="hidden lg:block">
                          <a href={waLink} target="_blank" rel="noopener noreferrer"
                             className="group inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#25D366] text-white text-sm font-bold hover:shadow-[0_8px_20px_rgba(37,211,102,0.3)] hover:-translate-y-0.5 transition-all duration-300">
