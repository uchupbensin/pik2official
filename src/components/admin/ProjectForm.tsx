  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Tambah Properti Baru</h2>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" name="name" required className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]" placeholder="Contoh: Tokyo Riverside" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Slug URL (Biarkan kosong untuk generate otomatis)</label>
                <input type="text" name="slug" className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]" placeholder="contoh: tokyo-riverside" />
              </div>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Deskripsi Singkat</label>
              <textarea name="short_description" rows={3} className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]"></textarea>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Lokasi</label>
                <input type="text" name="location" className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]" placeholder="Contoh: PIK 2, Jakarta Utara" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Nomor WhatsApp Khusus (Opsional)</label>
                <input type="text" name="whatsapp_number" className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]" placeholder="62812345..." />
              </div>
            </div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl flex gap-3 items-center">
              <input type="checkbox" name="is_promo" id="is_promo" className="w-5 h-5 rounded text-[#1E356A] focus:ring-[#1E356A]" />
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input type="text" name="meta_title" className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Meta Description</label>
              <textarea name="meta_description" rows={2} className="w-full px-4 py-2 border rounded-xl focus:ring-[#81A649] focus:border-[#81A649]"></textarea>
            </div>
          </div>
        </div>
